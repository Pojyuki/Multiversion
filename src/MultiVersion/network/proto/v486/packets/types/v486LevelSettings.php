...
final class v486LevelSettings{
	...
	private function internalRead(PacketSerializer $in) : void{
		...
		$this->spawnSettings = SpawnSettings::read($in->getReader());
	...
	public function write(PacketSerializer $out) : void{
		...
		($this->eduSharedUriResource ?? new EducationUriResource("", ""))->write($out->getWriter());
