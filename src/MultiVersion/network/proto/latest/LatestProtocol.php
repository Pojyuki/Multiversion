...
class LatestProtocol extends PacketTranslator{
	...
	public function __construct(){
		...
		$craftingDP = new CraftingDataPacket();
		$craftingDP->cleanRecipes = true;

		parent::__construct($typeConverter, $factory = new LatestPacketSerializerFactory(new LatestChunkSerializerWrapper()), PacketPool::getInstance(), ZlibCompressor::getInstance());
